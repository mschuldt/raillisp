...
(defun test-read ()
  (test "read 1" (eq? (read "1") 1))
  (test "read 2" (eq? (+ (read "1") 1) 2))
  (test "read 3" (eq? (read "nil") nil))
  (test "read 4" (equal? (read "x") 'x))
  (test "read 5" (equal? (read "(1 2 3)") '(1 2 3)))
  )
...
(defun test-list ()
  ...
  (test "list 4" (and (eq? (car (list nil)) nil)
                      (eq? (list-len (list nil)) 1)))
...
(defun test-str-count ()
  (test "str-count 1" (= (str-count "hello" "l") 2))
  (test "str-count 2" (= (str-count "hello" "x") 0))
  (test "str-count 3" (= (str-count "" "x") 0))
  (test "str-count 4" (= (str-count "hihixhi" "hi") 3))
  (test "str-count 5" (= (str-count "hello" "") 6))
  (test "str-count 5" (= (str-count "" "") 1))
  )
(test-str-count)
...
(defun test-if ()
  ...
  (test "if 3" (eq? (if (eq? 1 2) 1 2 3 4) 4))
...
(defun test-reverse ()
  (test "reverse 1" (equal? (reverse (list 1 2 3)) (list 3 2 1)))
  (test "reverse 2" (equal? (reverse (list 1)) (list 1)))
  (test "reverse 3" (equal? (reverse (list)) (list)))
  (test "reverse 4" (equal? (nreverse (list 1 2 3)) (list 3 2 1)))
  (test "reverse 5" (equal? (nreverse (list 1)) (list 1)))
  (test "reverse 6" (equal? (nreverse (list)) (list)))
  (var l (list 1 2 3))
  (var x (cdr l))
  (var r (reverse l))
  (test "reverse 7" (equal? r (list 3 2 1)))
  (setcar x 77)
  (test "reverse 8" (equal? r (list 3 2 1)))
  (var l (list 1 2 3))
  (var x (cdr l))
  (var r (nreverse l))
  (test "reverse 9" (equal? r (list 3 2 1)))
  (setcar x 77)
  (test "reverse 10" (equal? r (list 3 77 1)))
  )
(test-reverse)
...
(defun test-deep-copy ()
  (test "copy 1" (equal? (deep-copy 1) 1))
  (test "copy 2" (equal? (deep-copy "s") "s"))
  (test "copy 3" (equal? (deep-copy (list 2 3)) (list 2 3)))
  (test "copy 4" (equal? (deep-copy (list (list 2 3) 3))
                         (list (list 2 3) 3)))
  (test "copy 5" (equal? (deep-copy (vector 8 9)) (vector 8 9)))
  (var x (list (vector (list 1 "str" ))))
  (var xx (deep-copy x))
  (test "copy 6" (equal? x xx))
  (test "copy 7" (not (eq? x xx)))
  (test "copy 8" (not (eq? (car x) (car xx))))
  (test "copy 9" (not (eq? (vec-ref (car x) 0) (vec-ref (car xx) 0))))
  (test "copy 10" (not (eq? (cadr (vec-ref (car x) 0))
                            (cadr (vec-ref (car xx) 0)))))
  )
(test-deep-copy)
